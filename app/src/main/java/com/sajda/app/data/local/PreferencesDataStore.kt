...
class PreferencesDataStore(private val context: Context) {
    ...
    companion object {
        ...
        private val IMSAK_ENABLED = booleanPreferencesKey("imsak_enabled")
        private val SUNRISE_ENABLED = booleanPreferencesKey("sunrise_enabled")
    }
    ...
    val settingsFlow: Flow<UserSettings> = context.dataStore.data.map { preferences ->
        UserSettings(
            ...
            imsakAdzanEnabled = preferences[IMSAK_ENABLED] ?: true,
            sunriseAdzanEnabled = preferences[SUNRISE_ENABLED] ?: true,
    ...
    suspend fun setImsakEnabled(enabled: Boolean) {
        context.dataStore.edit { preferences ->
            preferences[IMSAK_ENABLED] = enabled
        }
    }

    suspend fun setSunriseEnabled(enabled: Boolean) {
        context.dataStore.edit { preferences ->
            preferences[SUNRISE_ENABLED] = enabled
        }
    }
    ...
    suspend fun restoreSettings(snapshot: UserSettings) = context.dataStore.edit { preferences ->
        ...
        preferences[IMSAK_ENABLED] = snapshot.imsakAdzanEnabled
        preferences[SUNRISE_ENABLED] = snapshot.sunriseAdzanEnabled
    }
